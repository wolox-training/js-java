...
class BookControllerTest {
    ...
    @Test
    @Order(12)
    public void givenBooks_whenGetSearchBooksByPagesAndYear_thenReturnJsonArray() throws Exception {
        Book book1 = new Book("pepa1", "pepa1", "Image1", "momo1", "1", "1", "2021", 361, "78945678945961");

        List<Book> allBooks = Arrays.asList(book1);

        given(bookRepository.findByAllParameters(null, null, null, null, null, null, null, "2021", "2021", "361", null))
                .willReturn(allBooks);

        Mvc.perform(get("/api/books/search?yearFrom=2021&yearTo=2021&pages=361")).andDo(print())
                .andExpect(status().isOk()).andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$[0].isbn").value("78945678945961")).andExpect(jsonPath("$", hasSize(1)));
    }
