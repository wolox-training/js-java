...
//    @NotBlank String year);
	...
	@Query("select u from Book u where (u.id = :id or null = :id) " + "and (u.genre = :genre or null = :genre)"
	        + "and (u.author = :author or null = :author)" + "and (u.image = :image or null = :image)"
	        + "and (u.title = :title or null = :title)" + "and (u.subtitle = :subtitle or null = :subtitle)"
	        + "and (u.publisher = :publisher or null = :publisher)"
	        + "and (null = :yearFrom or null = :yearTo or u.year between :yearFrom and :yearTo )"
	        + "and (u.pages = :pages or null = :pages)" + "and (u.isbn = :isbn or null = :isbn)")
